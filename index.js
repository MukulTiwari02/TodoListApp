...
function addElement(){
    ...
    newLi.innerHTML=`<h7 class = "newtag">${input.value.toUpperCase()}</h7>
    ...
    newLi.querySelector(".newtag").addEventListener("click", markDone);
...
function editEle(){
    ...
    this.previousElementSibling.classList.remove("markdone");
    ...
    if(this.textContent == "EDIT")
    {
        ...
        this.previousElementSibling.removeEventListener("click", markDone);
    }
    else {
        ...
        else 
        {
            ...
            this.previousElementSibling.addEventListener("click", markDone);
        }
    }
}
